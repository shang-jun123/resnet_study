...
def main():
    ...
    #image_path = r"D:\\git\\datasets\\mini-spvdata6"
    ...
    model_weight_path = "checkpoint_pre//200-spvdata-bzresnet18.pth"
    ...
    #name_file = '200tle=100ft-lr5-spvdata6-resnet18'
    name_file = '200tl-qtsu-pvdata6-resnet18'
    ...
    for epoch in range(epochs):
        # if epoch==100:
        #     print(epoch)
        #     model_weight_path = './' + name_file + '.pth'
        #     assert os.path.exists(model_weight_path), "file {} does not exist.".format(model_weight_path)
        #     net.load_state_dict(torch.load(model_weight_path, map_location=device))
        #     for param in net.parameters():
