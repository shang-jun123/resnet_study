...
file_r = open('2TL//100-Itltrue-minispvdata6-bzresnet18.txt')
epoch_list=[]
accuracy_list=[]
loss_list=[]
...
file_r1 = open('2TL//100-I2tltrue-minispvdata6-bzresnet18.txt')
accuracy_list1=[]
loss_list1=[]
...
file_r2 = open('2TL//100-Itltrue-spvdata8-2-bzresnet18.txt')
accuracy_list2=[]
loss_list2=[]
...
# file_r3 = open('kaggleminispvdata6//200tle=50ftlr=5-spvdata6-resnet18-2.txt')
# accuracy_list3=[]
# loss_list3=[]
#
# for f in file_r3:
...
plt.plot(epoch_list, accuracy_list1,'--',label='FResNet18')
plt.plot(epoch_list, accuracy_list2,'-.',label='TResNet18')
#plt.plot(epoch_list, accuracy_list3,'-.',label='FTResNet18')
...
plt.plot(epoch_list, loss_list1,'-.',label='FResNet18')
plt.plot(epoch_list, loss_list2,'-.',label='TPResNet18')
#plt.plot(epoch_list, loss_list3,'-.',label='FTResNet18')
plt.legend(fontsize=20)
#plt.grid()
plt.show()