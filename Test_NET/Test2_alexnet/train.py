...
from Googlenet import AlexNet
from model_2 import ResNet18
...
def main():
    ...
    image_path='D:\\git\\datasets\\flower_data'
...
'''
    ...
    for epoch in range(epochs):
        ...
        print('[epoch %d] train_loss: %.3f  val_accuracy: %.3f  train_time:%.2f s' %
              (epoch + 1, running_loss / train_steps, val_accurate,(time.perf_counter()-t1)))
