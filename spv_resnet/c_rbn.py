...
class RepresentativeBatchNorm2d(nn.BatchNorm2d):
    def __init__(self, num_features, eps=1e-5, momentum=0.1, affine=True,
        ...
        self.stas = nn.AdaptiveMaxPool2d((1, 1))
    ...
    def forward(self, input):
        ...
        scale_factor = torch.sigmoid(self.center_weight * self.stas(output) )
...
if __name__ == '__main__':
    images = torch.rand(1, 256, 224, 224)
    rbn_layer = RepresentativeBatchNorm2d(256)
