...
class  ResNet18 (nn.Module):
    def __init__(self):
        ...
        self.bn1 = RepresentativeBatchNorm2d(16)
        self.relu1 = nn.ReLU(inplace=True)
        self.conv2 = nn.Conv2d(16, 64, kernel_size=3, stride=1,
                               padding=1, bias=False)
        self.bn2 = RepresentativeBatchNorm2d(64)
