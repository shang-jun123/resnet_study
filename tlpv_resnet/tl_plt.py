...
file_r = open('30-spvdata//30-spvdata_resnet18.txt')
#file_r = open('tl_kaggle//200-spvdata-resnet18.txt')
#file_r = open('tl-spvdata-divide//30-spvdata8_2resnet18.txt')
...
file_r1 = open('30-spvdata//30tl-spvdata-resnet18.txt')
#file_r1 = open('tl_kaggle//200tl-spvdata-resnet18.txt')
#file_r1 = open('tl-spvdata-divide//30-spvdata5_5resnet18.txt')
...
print(t)
# ##第三条曲线
file_r2 = open('30-spvdata//30-spvdata_resnet34.txt')
accuracy_list2=[]
loss_list2=[]
...
# ##第四条曲线
file_r3 = open('30-spvdata//30-spvdata_resnet50.txt')
accuracy_list3=[]
loss_list3=[]
...
#plt.plot(epoch_list, accuracy_list3,linestyle=':',label='Resnet50')
...
#plt.plot(epoch_list, loss_list3,linestyle=':',label='Resnet50')
plt.legend(fontsize=15)
#plt.grid()
plt.show()